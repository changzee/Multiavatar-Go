...
// themes holds the color variations for different avatar parts.
// It's a direct port from the original JavaScript library.
var themes = map[string]map[string]map[string][]string{
	"00": {
		"A": {
			"env":   {"#ff2f2b"},
			"clo":   {"#fff", "#000"},
